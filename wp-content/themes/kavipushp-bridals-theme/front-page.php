    ...
    <section class="kp-dash-nav">
        <div class="container">
            ...
            <div class="kp-nav-grid">
                ...
                <a href="<?php echo admin_url('admin.php?page=kavipushp-availability'); ?>" class="kp-nav-card">
                    <div class="kp-nav-icon" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                        <i class="fas fa-check-circle"></i>
                    </div>
                    <h3><?php _e('Availability of Sets', 'kavipushp-bridals'); ?></h3>
                    <p><?php _e('Check booked & available jewelry sets', 'kavipushp-bridals'); ?></p>
                    <span class="kp-nav-arrow"><i class="fas fa-arrow-right"></i></span>
                </a>
                ...
                if ($wpdb->get_var("SHOW TABLES LIKE '$inv_table'") === $inv_table) {
                    $inv_count = intval($wpdb->get_var("SELECT COUNT(*) FROM $inv_table"));
                }
                ?>
                <a href="<?php echo admin_url('admin.php?page=kavipushp-invoices'); ?>" class="kp-nav-card">
                    <div class="kp-nav-icon" style="background: linear-gradient(135deg, #c9a86c 0%, #f0d890 100%);">
                        <i class="fas fa-file-invoice-dollar"></i>
                    </div>
                    <h3><?php _e('Saved Invoices', 'kavipushp-bridals'); ?></h3>
                    <p><?php printf(__('%d invoices saved. View & print invoices', 'kavipushp-bridals'), $inv_count); ?></p>
                    <span class="kp-nav-arrow"><i class="fas fa-arrow-right"></i></span>
                </a>
            </div>
        </div>
